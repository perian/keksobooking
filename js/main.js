 ...
 * const MAIN_CLICK = 0;
  ...
  const onMainPinClick = (evt) => {
    ...
    window.mainPin.removeEventListener(`mousedown`, onMainPinClick);
  };
  ...
  const onMainPinEnter = (evt) => {
    ...
    window.mainPin.removeEventListener(`keydown`, onMainPinEnter);
  };

  window.mainPin.addEventListener(`mousedown`, onMainPinClick);
  window.mainPin.addEventListener(`keydown`, onMainPinEnter);
 */
